...
Credentialed CORS requests are accepted only from `https://raperonzolo.com`, `https://test.raperonzolo.com`, and `https://raperonzolo-app-test-xwpvf.ondigitalocean.app`. The authentication cookie is secure and configured for cross-site requests.
